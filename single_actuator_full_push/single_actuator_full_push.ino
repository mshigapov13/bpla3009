...
int ACTUATOR_FULL_PUSH_TIME = 30000;

enum Actuator { BATTERY_SWAPER_ACTUATOR_RIGHT,
...
void actuator_full_push(int actuatorToReset) {
  digitalWrite(uno_dgt_pins[actuatorToReset][IN1], HIGH);
  digitalWrite(uno_dgt_pins[actuatorToReset][IN2], LOW);
